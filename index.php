...
<head>
  ...
  <link href="css/bootstrap.min.css" rel="stylesheet" alt="versão (5.2.3)">
  ...
  <link rel="icon" type="image" sizes="50x50" href="img/nav/icon.png">
  <link rel="stylesheet" href="css/aos.css" />
</head>

<body>
  <script src="js/bootstrap.bundle.min.js" alt="versão (5.2.3)"></script>
  <!--inicio da navbar-->
  <nav class="navbar navbar-expand-lg slide-down">
    <a class="navbar-brand" href="lgs.html">
      <div class="container">
        <img src="img/nav/logotipo-etec.svg" alt="Bootstrap" width="128" height="52" title="Etec Itanhaém">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="docs/conselho/atribuicoes.pdf">Conselho Escolar</a></li>
            <li><a class="dropdown-item" href="apm.html">APM</a></li>
            <li><a class="dropdown-item" href="historico.html">Histórico</a></li>
            <li><a class="dropdown-item" href="docs/escola/regimento.pdf">Regimento Comum</a></li>
            <li><a class="dropdown-item" href="docs/escola/Observatorio.pdf">Observatório</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="dds.html">Desenvolvimento de Sistemas</a></li>
            <li><a class="dropdown-item" href="adm.html">Administração</a></li>
            <li><a class="dropdown-item" href="fma.html">Farmácia</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="mae.html">Meio Ambiente</a></li>
            <li><a class="dropdown-item" href="adm.html">Administração</a></li>
            <li><a class="dropdown-item" href="ipi.html">Informática para Internet</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="docs/aluno/manual.pdf">Manual do Aluno</a></li>
            <li><a class="dropdown-item" href="https://nsa.cps.sp.gov.br">NSA</a></li>
            <li><a class="dropdown-item" href="docs/aluno/normas.pdf">Normas de Convivência</a></li>
            <li><a class="dropdown-item" href="tcc.html">TCC</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="https://www.vestibulinhoetec.com.br/candidato/">Área do Canditado</a>
            </li>
            <li><a class="dropdown-item" href="https://www.vestibulinhoetec.com.br/calendario/">Calendário</a></li>
            <li><a class="dropdown-item" href="https://www.vestibulinhoetec.com.br/fale-conosco/">Contato</a></li>
            <li><a class="dropdown-item"
                href="https://www.vestibulinhoetec.com.br/duvidas-frequentes/">Duvidas-frequentes</a></li>
          </ul>
        </li>
        <li class="nav-item">
      ...
      <div class="cps">
        <a href="https://www.cps.sp.gov.br/etecs/etec-de-itanhaem/" class="pull-right" target="_blank"><img width="100"
            height="52" src="img/nav/centro-paula-souza-logo.svg"
            class="custom-logo jetpack-lazy-image jetpack-lazy-image--handled" alt="Centro Paula Souza" decoding="async"
            data-lazy-loaded="1" loading="eager" title="Centro Paula Souza"></a>
      </div>
      <div class="spacel"></div>
      <label class="theme-switch">
        <input type="checkbox" class="theme-switch__checkbox" id="suninmoon">
  ...
  <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active c-item">
        <img id="sld1" src="img/hme/carrosel-img-01.jpg" class="d-block w-100 c-img zoom-effect"
      ...
      <div class="carousel-item c-item">
        <img src="img/hme/5 Cursos.png" class="d-block w-100 c-img zoom-effect" alt="Slide 2" id="sld2">
        <div class="carousel-caption top-1 mt-0">
        </div>
      </div>
      <div class="carousel-item c-item">
        <img id="sld2" src="img/hme/Ensino Médio & Técnico.png" class="d-block w-100 c-img zoom-effect" alt="Slide 3">
        <div class="carousel-caption top-1 mt-0">
        </div>
      </div>
    </div>
  ...
  <div class="unidade-cursos" data-aos="fade-up">
    ...
    <p>
      <a id="und-txt" href="adm.html">Administração</a><br>
      <a id="und-txt" href="dds.html">Desenvolvimento de Sistemas</a><br>
      <a id="und-txt" href="fma.html">Farmácia</a><br>
    </p>
    <h5>Ensino Médio integrado ao técnico (M-Tec)</h5>
    <p>
      <a id="und-txt" href="adm.html">Administração</a><br>
      <a id="und-txt" href="ipi.html">Informática para Internet</a><br>
      <a id="und-txt" href="mae.html">Meio Ambiente</a><br>
    </p>
    <br>
  </div>
  <div id="m-tec"></div>
  ...
  <div id="container01" class="container" style="align-items: center; text-align: center;">
    <div class="row">
      <div class="col-lg">
        <a href="adm.html"><img src="img/hme/fafaadm.png" width="140" height="140" alt="icone de administração"
            title="Curso de administração"></a>
        <h2 class="fw-normal">Administração</h2>
      </div>
      <br>
      <div class="col-lg">
        <a href="fma.html"><img src="img/hme/fafafma.png" width="140" height="140" alt="icone de farmácia"
            title="Curso de Farmácia"></a>
        <h2 class="fw-normal">Farmácia</h2>
      </div>
      <br>
      <div class="col-lg">
        <a href="dds.html"><img src="img/hme/fafadds.png" width="140" height="140"
      ...
      <br>
      <div class="col-lg">
        <a href="ipi.html"><img src="img/hme/fafaipi.png" width="140" height="140"
      ...
      <br>
      <div class="col-lg">
        <a href="mae.html"><img src="img/hme/fafamae.png" width="140" height="140" alt="icone de Meio-ambiente"
  ...
  <div id="m-tec-intro" class="container" data-aos="fade-up">
    <img id="introgirl" width="880" height="700" src="img/hme/img-girl-01.jpeg" class="img-fluid text-justify">
        ...
        <div class="row">
          <section class="col-sm-4">
            <article class="card" data-aos="fade-left">
              <a href="https://pt.wikipedia.org/wiki/Paulo_Freire"><img src="img/hme/paulofreire.png"
            ...
            <article class="card" data-aos="fade-down">
              <a
                href="https://www.poli.usp.br/institucional/diretoria/galeria-de-diretores/prof-dr-antonio-francisco-de-paula-souza"><img
                  src="img/hme/paulosouza.jpg" class="card-img-top" alt="Paula Souza" title="Paula Souza"></a>
              <div class="card-body">
          ...
          <section class="col-sm-4">
            <article class="card" data-aos="fade-right">
              <a href="https://pt.wikipedia.org/wiki/José_Serra"><img id="ft" src="img/hme/joseserra.jpeg"
  ...
  <div class="container">
    ...
    <section class="home-intro" data-aos="fade-right">
      <div class="home-intro__wrapper">
        <aside class="embed">
          <a href="dds.html"><img id="radius-img" class="img-fluid" width="560" height="315" src="img/hme/dev-img.jpeg"
    ...
    <section class="home-intro" data-aos="fade-right">
      <div class="home-intro__wrapper">
        <aside class="embed">
          <a href="adm.html"><img id="radius-img" width="560" class="img-fluid" height="315" src="img/hme/adm-img.jpeg"
    ...
    <section class="home-intro" data-aos="fade-right">
      <div class="home-intro__wrapper">
        <aside class="embed">
          <a href="fma.html"><img id="radius-img" width="560" class="img-fluid" height="315" src="img/hme/fma-img.jpeg"
  ...
  <div style="background-color: #000000;" class="container-fluid" class="img-fluid">
    ...
    <div style="background-color: #000000;" class="container-wrapper">
      <section style="background-color: #000000;" class="home-intro" data-aos="fade-left">
        <div style="background-color: #000000;" class="home-intro__wrapper">
          ...
          <aside style="background-color: #000000;" class="embed">
            <br>
            <a href="mae.html"><img id="radius-img" width="560" height="315" src="img/hme/mae-img.jpeg "
      ...
      <section style="background-color: #000000;" class="home-intro" data-aos="fade-left">
        <div style="background-color: #000000;" class="home-intro__wrapper">
          ...
          <aside style="background-color: #000000;" class="embed">
            <a href="ipi.html"><img id="radius-img" width="560" height="315" src="img/hme/ipi.jpeg"
      ...
      <div class="l-container site-footer__container">
        <div class="site-footer__row site-footer__row--navigation">
          ...
          <div class="site-footer__menu-col">
            ...
            <nav class="site-footer__nav" aria-label="Website Navigation">
              <ul type="none" class="site-footer__nav-list">
                ...
                <li class="footer-two__item"><a href="historico.html" class="footer-two__action"
          ...
          <div class="site-footer__menu-col">
            ...
            <nav class="site-footer__nav" aria-label="Get In Touch Navigation">
              <ul type="none" class="site-footer__nav-list">
                <li class="footer-three__item"><a href="contact.html" class="footer-three__action"
                    data-attribute="contact">Telefone &amp; Fax</a></li>
                <li class="footer-three__item"><a href="contact.html" class="footer-three__action"
        ...
        <div class="site-footer__row site-footer__row--secondary">
          ...
          <div class="site-footer__logo mx-auto ">
            <a href="">ㅤㅤ
              <img src="img/ftr/logo-white-svg.svg" alt="etec-de-itanhaem">
            </a>
          </div>
              ...
              <ul type="none" class="social-follow__list">
                <li class="social-follow__item social-follow__item--facebook">
                  <a href="https://www.facebook.com/etecdeitanhaem/?locale=pt_BR" class="social-follow__anchor"
                    ...
                    <img src="img/ftr/fbk.png" style="height: 50px;" alt="Facebook">
                  </a>ㅤ
                  <a href="https://br.linkedin.com/company/etec-itanhaém" class="social-follow__anchor"
                    ...
                    <img src="img/ftr/in.png" style="height: 50px;" alt="Linkedin">
                  </a>ㅤ
                  <a href="https://api.whatsapp.com/send?phone=551334264926" class="social-follow__anchor"
                    ...
                    <img src="img/ftr/wts.png" style="height: 50px;" alt="Whatsapp">
                  </a>ㅤ
                  <a href="https://www.instagram.com/etecdeitanhaem/" class="social-follow__anchor" rel="me noopener"
                    title="Instagram" target="_blank">
                    <img src="img/ftr/ins.png" style="height: 50px;" alt="Instagram">
                  </a>ㅤ
                </li>
              </ul>
            </div>
    ...
    <a href="#" class="to-top">
      <i class="fa fa-chevron-up" style="font-size:25px;color:rgb(0, 0, 0)"></i></a>
    <script src="js/main.js"></script>
    <!-- final da seção de scripts -->
</body>

</html>
<!-- Todos os direitos reservados a Eduardo dos Santos Ferreira -->