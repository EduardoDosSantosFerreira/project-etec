  ...
  <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active c-item">
        <img src="../assets/img/dds/dds-image-01.jpeg" class="d-block w-100 c-img zoom-effect" alt="Slide 1">
        <div class="carousel-caption">
          <h2>Programação</h2>
        </div>
      </div>
      <div class="carousel-item c-item">
        <img src="../assets/img/dds/dds-image-02.jpeg" class="d-block w-100 c-img zoom-effect" alt="Slide 2">
        <div class="carousel-caption">
          <h2>Design Gráfico</h2>
        </div>
      </div>
      <div class="carousel-item c-item">
        <img src="../assets/img/dds/dds-image-03.jpeg" class="d-block w-100 c-img zoom-effect" alt="Slide 3">
        <div class="carousel-caption">
  ...
  <div class="unidade-introducao" data-aos="fade-up">
    <div class="sc_content_container">
      <div id="sc_title_1459963616" class="sc_title sc_title_default">
        <br>
        <h2 class="sc_item_title sc_title_title sc_align_center sc_item_title_style_default">Desenvolvimento de Sistemas
        </h2>
        <div id="tex" class="sc_item_descr sc_title_descr sc_align_center">
          <p>O curso de desenvolvimento de sistemas é uma formação que
            prepara os estudantes para projetar, criar e implementar soluções de software eficientes e funcionais. O
            curso geralmente abrange uma ampla variedade de tópicos, incluindo programação, bancos de dados, design de
            software, engenharia de software, arquitetura de sistemas, segurança de dados e desenvolvimento web.

            Além disso, podem aprender sobre as
            melhores práticas de segurança cibernética e proteção de dados, garantindo que as aplicações que desenvolvem
            sejam seguras e protegidas contra ameaças cibernéticas.

            Um curso de desenvolvimento de sistemas pode ser oferecido em diferentes níveis, como técnico, graduação ou
            pós-graduação, e pode variar em duração e intensidade, dependendo da instituição e do programa específico.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="unidade-cursos" data-aos="fade-up">
      ...
      <h5>Informação e Comunicação</h5>
    ...
    <div class="container">
      ...
      <section class="home-intro" data-aos="fade-right">
        <div class="home-intro__wrapper">
          <aside class="embed">
            <img id="img-border" width="560" height="315" src="../assets/img/dds/dds-image-04.jpeg">
          </aside>
          <div>
            <h2 class="home-intro__title">
              Conheça
              <strong style="color: #00758f;">Design Gráfico</strong>
            </h2>

            <p class="home-intro__text">
              Design gráfico é a prática de criar soluções visuais para comunicar mensagens por meio de imagens, textos
              e gráficos. Os designers gráficos usam ferramentas e técnicas como softwares de design gráfico,
              tipografia, cor, composição, ilustração e fotografia para criar materiais visuais em projetos que variam
              desde logotipos e identidades visuais de empresas até materiais de marketing, publicidade, embalagens,
              livros e revistas. O objetivo é criar uma comunicação visual clara e atraente que transmita uma mensagem
              de maneira eficaz para o público-alvo, e para isso, os designers devem ter habilidades em comunicação
              visual, pensamento crítico, solução de problemas e criatividade. </p>
          </div>
        </div>
      </section>
      <br>
      ...
      <section class="home-intro" data-aos="fade-left">
        <div class="home-intro__wrapper">
          <aside class="embed">
            <img id="img-border" width="560" height="315" src="../assets/img/dds/dds-image-03.jpeg">
          </aside>
          <div>
            <h2 class="home-intro__title">
              Conheça
            ...
            <p class="home-intro__text">
              ...
              ../pages/administração de bancos de dados, entre outros. A disciplina é importante para áreas como TI e
              negócios,
      ...
      <section class="home-intro" data-aos="fade-right">
        <div class="home-intro__wrapper">
          <aside class="embed">
            <img id="img-border" width="560" height="315" src="../assets/img/dds/dds-image-06.jpeg">
          </aside>
          <div>
            <h2 class="home-intro__title">
              Conheça
              <strong style="color: #00758f;">Programação Web</strong>
            </h2>
      ...
      <section class="home-intro" data-aos="fade-left">
        <div class="home-intro__wrapper">
          <aside class="embed">
            <img id="img-border" width="560" height="315" src="../assets/img/dds/dds-image-07.jpeg">
          </aside>
          <div>
            <h2 class="home-intro__title">
              Conheça
              <strong style="color: #3947b0;">Operação de software e aplicativos</strong>
            </h2>
            ...
            <p class="home-intro__text">
              ...
              de dados do usuário e suporte ao usuário.</p>
          </div>
        </div>
      </section>
      <br>
      ...
      <section class="home-intro" data-aos="fade-right">
        <div class="home-intro__wrapper">
          <aside class="embed">
            <img id="img-border" width="560" height="315" src="../assets/img/dds/dds-image-08.jpeg">
          </aside>
          <div>
            <h2 class="home-intro__title">
              Conheça
            ...
            <p class="home-intro__text">
              ...
              programação mais populares incluem Java, Python, C++, JavaScript, Ruby e PHP. O desenvolvimento de
              habilidades em programação é fundamental para profissionais de TI e engenheiros de software que desejam
              criar soluções personalizadas e automatizar processos em diversas áreas de atuação.
          </div>
        </div>
      </section>
      <br>
